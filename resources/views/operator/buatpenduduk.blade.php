<x-layout>
    ...
    <x-slot:tabs>Tambah Penduduk</x-slot>
    ...
    <body>
        <div class="container mt-3">
            <form action="addpenduduk" method="POST" id="pendudukForm">
                ...
                <div class="mb-3">
                    <label for="kartu_sehat" class="form-label">Nomor Kartu Sehat</label>
                    <input type="text" class="form-control" id="kartu_sehat" name="kartu_sehat" required>
                </div>
                <div class="mb-3">
                    <label for="status_perkawinan" class="form-label">Status Perkawinan</label>
                    <select
                        class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 py-2.5"
