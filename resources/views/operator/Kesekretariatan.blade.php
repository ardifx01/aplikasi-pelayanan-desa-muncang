<x-layout>
    ...
    <x-slot:tabs>Kesekretariatan</x-slot>
        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    @if (
                        $item->jenis_surat != 'SKD' &&
                            $item->jenis_surat != 'SKBA' &&
                            $item->jenis_surat != 'SKTMS' &&
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item hapussurat" href="/hapussurat/{{ $item->id }}"
                                            data-nomor-surat="{{ $item->nomor_surat }}">Hapus</a></li>
                    ...
                    @else
                        <td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="/showeditsurat/{{ $item->id }}">Edit</a>
                                    </li>
                                    <li><a class="dropdown-item" href="/cetaksurat/{{ $item->id }}"
