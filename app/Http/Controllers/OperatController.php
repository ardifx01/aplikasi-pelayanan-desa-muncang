...
class OperatController extends Controller
{
    ...
    public function editpenduduk(Request $request, $NIK)
    {
        ...
        $data->update([
            ...
            'kartu_sehat' => $request->input('kartu_sehat'),
        ]);
    ...
    public function addPenduduk(Request $request)
    {
        ...
        $request->validate([
            ...
            'RW' => 'required|integer',
            'kewarganegaraan' => 'required|in:WNI,WNA',
            'kartu_sehat' => 'required|string|max:16',
        ], [
            'kk.required' => 'Nomor KK wajib diisi.',
            'kk.string' => 'Nomor KK harus berupa teks.',
            'kk.max' => 'Nomor KK maksimal 16 karakter.',
    ...
    public function showdashboard()
    {
        ...
        $suratData = [
            'SKBA' => daftarsurat::where('jenis_surat', 'SKBA')->count(),
            ...
            'Lain-lain' => daftarsurat::whereNotIn('jenis_surat', ['SKBA', 'SKD', 'SKTMS', 'SKTM', 'SKK', 'SKWN', 'SKP', 'SKCK'])->count()
        ];
